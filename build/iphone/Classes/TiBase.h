...
// in simulator we redefine to format for liftKaraDe Developer console
...
{\
	NSString * exceptionName = [@"org.liftkarade." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.liftkarade";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIliftKaraDeNativeItemNone = -1, 
	UIliftKaraDeNativeItemSpinner = -2,
	UIliftKaraDeNativeItemProgressBar = -3,
	
	UIliftKaraDeNativeItemSlider = -4,
	UIliftKaraDeNativeItemSwitch = -5,
	UIliftKaraDeNativeItemMultiButton = -6,
	UIliftKaraDeNativeItemSegmented = -7,
	
	UIliftKaraDeNativeItemTextView = -8,
	UIliftKaraDeNativeItemTextField = -9,
	UIliftKaraDeNativeItemSearchBar = -10,
	
	UIliftKaraDeNativeItemPicker = -11,
	UIliftKaraDeNativeItemDatePicker = -12,
	
	UIliftKaraDeNativeItemInfoLight = -13,
	UIliftKaraDeNativeItemInfoDark = -14,
	
	UIliftKaraDeNativeItemDisclosure = -15,
	
	UIliftKaraDeNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all liftKaraDe instances of

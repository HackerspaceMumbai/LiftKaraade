...
/**
 Base class for all liftKaraDe views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the liftKaraDe view hierarchy (such as wrapped iOS UIViews) was touched.

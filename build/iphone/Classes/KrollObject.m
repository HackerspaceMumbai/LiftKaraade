 ...
 * Copyright (c) 2009-2011 by liftKaraDe, Inc. All Rights Reserved.
...
//@interface liftKaraDeObject : NSObject
//@end

@interface liftKaraDeObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[liftKaraDeObject class]])
		{
			for (NSString *key in [[(liftKaraDeObject*)o modules] allKeys])
			{

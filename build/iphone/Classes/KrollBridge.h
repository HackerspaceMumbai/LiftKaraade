...
@interface liftKaraDeObject : KrollCoverageObject {
#else
@interface liftKaraDeObject : KrollObject {
#endif
@private
...
extern NSString * liftKaraDe$ModuleRequireFormat;

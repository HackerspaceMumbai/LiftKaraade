...
static NSString * const kliftKaraDeJavascript = @"Ti.App={};Ti.API={};Ti.App._listeners={};Ti.App._listener_id=1;Ti.App.id=Ti.appId;Ti.App._xhr=XMLHttpRequest;"
...
-(NSString*)_liftkaradeInjection
{
	...
	[html appendString:kliftKaraDeJavascript];
...
{
	// attempt to make well-formed HTML and inject in our liftKaraDe bridge code
	...
	if (range.location!=NSNotFound)
	{
		...
		if (nextRange.location!=NSNotFound)
		{
			...
			[html appendString:[self _liftkaradeInjection]];
